...
public class StructureComponentVillageHouse extends StructureComponentVillage
{
    ...
    public StructureComponentVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
