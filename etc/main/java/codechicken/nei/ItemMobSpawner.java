...
public class ItemMobSpawner extends ItemBlock
{
    ...
    public static void loadSpawners(World world) {
        ...
        // PISTON: use reflection access. I can't get this to compile otherwise. :(
        HashMap<Class<Entity>, Integer> classToIDMapping;
        try {
            Class<?> clazz = EntityList.class;
            java.lang.reflect.Field f = clazz.getDeclaredField("classToIDMapping");
            Object o = f.get(null);
            classToIDMapping = (HashMap<Class<Entity>, Integer>) o;
        } catch (Throwable t) {
            return;
        }
